    ...
    <Flex bg="#210011"  flexDirection="column">
      ...
      >
        {swiperData.map((el,id)=>{
          return(
            <SwiperSlide  key={id}> 
            <Flex  maxWidth="838px" justifyContent="center" alignItems="center" gap={["0px","58px","58px","58px"]} mt={["50px","50px","80px","80px"]} mb={["86px","86px","128px","128px"]} flexDirection={["column","column","row","row"]}>
              <Box borderRadius="100%" overflow="hidden"  height={["200px","300px","230px","230px"]} width={["200px","300px","500px","500px"]} position="relative">
