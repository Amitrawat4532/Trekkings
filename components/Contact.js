...
const Contact = () => {
  ...
  return (
     ...
     <Flex h="100vh" width="100%" justifyContent="center" alignItems="center" flexDirection="column" overflow="hidden"  > 
...
<path d="M25.1092 3.89954C25.3242 3.69206 25.4957 3.44384 25.6138 3.16936C25.7318 2.89488 25.794 2.59963 25.7968 2.30085C25.7995 2.00207 25.7427 1.70573 25.6297 1.42913C25.5167 1.15253 25.3498 0.901213 25.1386 0.689833C24.9275 0.478453 24.6763 0.311248 24.3999 0.197974C24.1234 0.0846992 23.8271 0.0276249 23.5284 0.0300794C23.2296 0.0325339 22.9344 0.0944686 22.6598 0.21227C22.3852 0.330072 22.1369 0.501381 21.9292 0.716202L12.9112 9.73217L3.89614 0.716202C3.69015 0.495118 3.44175 0.317792 3.16575 0.194803C2.88975 0.0718142 2.59181 0.00568112 2.2897 0.000350197C1.98759 -0.00498073 1.6875 0.0505999 1.40734 0.163775C1.12717 0.27695 0.87267 0.445402 0.659013 0.659081C0.445356 0.87276 0.276922 1.12729 0.163758 1.40748C0.0505946 1.68768 -0.00498021 1.9878 0.000350161 2.28994C0.00568053 2.59208 0.0718068 2.89005 0.194783 3.16608C0.31776 3.4421 0.495067 3.69053 0.716128 3.89654L9.72516 12.9155L0.710128 21.9315C0.312687 22.358 0.0963157 22.9222 0.1066 23.5052C0.116885 24.0882 0.353023 24.6444 0.765263 25.0567C1.1775 25.469 1.73366 25.7051 2.31657 25.7154C2.89947 25.7257 3.46361 25.5093 3.89014 25.1118L12.9112 16.0958L21.9262 25.1148C22.3527 25.5123 22.9169 25.7287 23.4998 25.7184C24.0827 25.7081 24.6388 25.472 25.0511 25.0597C25.4633 24.6474 25.6995 24.0912 25.7097 23.5082C25.72 22.9252 25.5037 22.361 25.1062 21.9345L16.0972 12.9155L25.1092 3.89954Z" fill="#571432"/>
      ...
      <Flex w={["100%","100%","990px","990px"]} h="100%" bgColor="white" px={["21px","21px","83px","83px"]}  flexWrap="wrap" >
        <Flex gap="5px" flexDirection="column" width={["100%","100%","50%","50%"]}  py={['15px','15px','20px','25px']}>
         <Text color="black" fontSize="16px" fontFamily="Popins" fontWeight="500" lineHeight="25px">Name</Text>
         <input type='text' required name='entry.1464953987'  className='inputbox' placeholder='enter your full name' fontSize="17px" bgColor="red" width="350px" fontFamily="Popins" fontWeight="500" lineHeight="25px" />
         <Box pt="7px">
...
<path d="M0 0.832031H347.924" stroke="#8D8D8D" stroke-width="1.25152"/>
        ...
        <Flex gap="5px" flexDirection="column" width={["100%","100%","50%","50%"]}  py={['15px','15px','20px','25px']}>
         ...
         <input type='number' required name='entry.427502725' placeholder='+91 00 00 00 00 00' className='inputbox' fontSize="17px" width="350px" fontFamily="Popins" fontWeight="500" lineHeight="25px" />
         <Box pt="7px">
        <svg width="348" height="2" viewBox="0 0 348 2" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M0 0.832031H347.924" stroke="#8D8D8D" stroke-width="1.25152"/>
</svg>
        ...
        <Flex gap="5px" flexDirection="column" width={["100%","100%","50%","50%"]}  py={['15px','15px','20px','25px']}>
         ...
         <input type='email'  required name='entry.1880272626' className='inputbox' placeholder='abc@gmail.com' fontSize="17px" width="350px" fontFamily="Popins" fontWeight="500" lineHeight="25px" />
         <Box pt="7px">
        <svg width="348" height="2" viewBox="0 0 348 2" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M0 0.832031H347.924" stroke="#8D8D8D" stroke-width="1.25152"/>
</svg>
        ...
        <Flex gap="5px" flexDirection="column" width={["100%","100%","50%","50%"]}  py={['15px','15px','20px','25px']}>
         <Text color="black" fontSize="16px" fontFamily="Popins" fontWeight="500" lineHeight="25px">No. of Travellers</Text>
         <input type='number' required  className='inputbox' name='entry.1777147701' placeholder='number of travellers' fontSize="17px" width="350px" fontFamily="Popins" fontWeight="500" lineHeight="25px" />
         <Box pt="7px">
        <svg width="348" height="2" viewBox="0 0 348 2" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M0 0.832031H347.924" stroke="#8D8D8D" stroke-width="1.25152"/>
</svg>
        ...
        <Flex gap="5px" flexDirection="column" width="100%"  py={['15px','15px','20px','25px']}>
         <Text color="black" fontSize="16px" fontFamily="Popins" fontWeight="500" lineHeight="25px">
        Message

         </Text>
         <input type='text' required name='entry.1548824761' placeholder='write your message...' fontSize="17px" width="350px" fontFamily="Popins" fontWeight="500" lineHeight="25px" />
...
<path d="M0 0.832031H347.924" stroke="#8D8D8D" stroke-width="1.25152"/>
        ...
        <Flex gap="15px" flexDirection="column" width={["100%","100%","50%","50%"]}  py={['15px','15px','20px','25px']}>
...
<Text color="#565656" fontSize="14px" fontFamily="Popins" fontWeight="500" lineHeight="25px">This data will be used by our team to contact you and no other purpose</Text>
        ...
        <Flex gap="15px" flexDirection="column" width={["100%","100%","50%","50%"]}  py={['15px','15px','20px','25px']} alignItems={["center","center","end","end"]}>
        <Button bgColor="#241314" variant="ContactButton" type='submit' color="white" fontFamily="Poppins" fontSize="24px" fontWeight="500" maxW={["100%","100%","294px","294px"]} width="100%" px={["18px","18px","72px","72px"]}  py={["24px","24px","40px","40px"]}>Send details</Button>
        </Flex>
